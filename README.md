...
**2026 年 9 月更新稿**：资料核对截至 **2026-09-24**，已纳入 **Opus 5.5、Fable 5.1**，新模型示例使用 Claude Code **2.1.280 或更新版本**。本稿已按官方资料修订；真实账号操作、Windows 路径及另一引擎审校的完成情况见[版本与核验说明](docs/版本与核验说明.md)。
...
当前是九月修订候选，修订分支供阅读与审校，尚未作为正式里程碑发行。旧的章节地址保留；第 0 章与附录 J 的历史文件名不代表其当前内容。
