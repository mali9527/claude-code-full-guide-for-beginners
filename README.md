...
**[从头连续读完整本书 →](全书.md#preface)**

从前言开始，一路向下读完正文和附录，需要时也可用目录跳转。

[新模型使用指南](manuscript/附录/J-Opus-4.7新手指南.md) · [按需找章节](#从你现在的问题开始)
...
| 你的需要 | 建议入口 |
|---|---|
| 完全没用过，想从头学 | [从前言开始连续读](全书.md#preface)，接着了解账号与费用，再开始安装 |
...
也可按[手绘插图索引](assets/illustrations/读图索引.md)查找概念，或从[桌面应用导览](manuscript/附录/H-桌面应用导览.md)了解图形界面。
